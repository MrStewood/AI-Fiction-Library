...
python3 tools/studio.py pack \
  --slug <book-slug> --role continuity_reviewer --work continuity --unit SCENE-013
```
...
## Done gate
Write continuity review to `job.deliverable_path`. Update ledger notes if assigned. Do not rewrite prose.
