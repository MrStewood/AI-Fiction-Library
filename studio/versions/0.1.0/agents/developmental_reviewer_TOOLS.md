...
python3 tools/studio.py pack \
  --slug <book-slug> --role developmental_reviewer --work craft_audit --unit SCENE-013
```
...
## Done gate
Write STRICT JSON craft audit to `job.deliverable_path` with quoted evidence.
Diagnose only — do not rewrite prose.
