...
python3 tools/studio.py pack \
  --slug <book-slug> --role drafting_author --work draft --unit SCENE-013
```
...
## Done gate
`job.done_gate_command` from pack (verify-done + craft_lint for scenes).
If craft_lint fails: redraft; do not mark done.
