...
python3 tools/studio.py pack \
  --slug <book-slug> --role line_editor --work line_edit --unit SCENE-013
```
...
## Done gate
Line-edit assigned material in place. Append concise change summary under `revisions/LINE_EDIT_LOG.md`.
Do not change plot/canon outcomes.
