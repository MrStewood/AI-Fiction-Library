...
python3 tools/studio.py pack \
  --slug <book-slug> --role research_specialist --work research --unit SCENE-013
```
...
## Done gate
Write research notes to `job.deliverable_path`. Cite sources; mark uncertainty. No manuscript prose.
