...
python3 tools/studio.py pack \
  --slug <book-slug> --role revision_editor --work revision --unit SCENE-013
```
...
## Done gate
Apply ONLY the Revision Brief from pack. Prefer updating the same artifact path.
Write change log under `revisions/`.
